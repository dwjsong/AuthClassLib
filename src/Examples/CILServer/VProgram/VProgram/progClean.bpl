...
implementation PoirotMain.Main()
{
  ...
  anon0:
    ...
    call T$CILRepository.Controllers.AccountController.$Manage$o__SiteContainer1f.#cctor();
    call T$CILRepository.Controllers.AccountController.$Manage$o__SiteContainer23.#cctor();
    call T$CILRepository.Controllers.AccountController.$ExternalLoginCallback$o__SiteContainer29.#cctor();
    call T$CILRepository.Controllers.AccountController.$ExternalLoginConfirmation$o__SiteContainer3a.#cctor();
    call T$CILRepository.Controllers.AccountController.$RemoveAccountList$o__SiteContainer44.#cctor();
