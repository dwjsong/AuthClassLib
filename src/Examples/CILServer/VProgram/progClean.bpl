...
implementation PoirotMain.Main()
{
  ...
  anon0:
    ...
    call T$CILRepository.Controllers.AccountController.$Manage$o__SiteContainer1a.#cctor();
    call T$CILRepository.Controllers.AccountController.$Manage$o__SiteContainer1e.#cctor();
    call T$CILRepository.Controllers.AccountController.$ExternalLoginCallback$o__SiteContainer24.#cctor();
    call T$CILRepository.Controllers.AccountController.$ExternalLoginConfirmation$o__SiteContainer35.#cctor();
    call T$CILRepository.Controllers.AccountController.$RemoveAccountList$o__SiteContainer3f.#cctor();
