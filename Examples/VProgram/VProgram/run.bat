...
call %POIROT_ROOT%\Poirot4.NET\BCT\BytecodeTranslator.exe /e:1 /ib /whole /heap:splitFields %file_name%.exe bin\Debug\OpenIDConnectNameSpace.dll bin\Debug\GenericAuthNameSpace.dll bin\Debug\LiveID.dll bin\Debug\OAuth20NameSpace.dll bin\Debug\CST.dll
